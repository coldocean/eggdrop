# WUNDERkind Eggdrop bot — task notes

## Goal
Eggdrop bot for Wunderbar IRC. Repo coldocean/eggdrop, deploy on Railway (same
...
## Config decisions
- Bot nick: WUNDERkind (alt WUNDERk1nd)
...
- [ ] create GitHub repo coldocean/eggdrop + push
- [ ] create Railway service from repo
- [ ] set env vars + volume
- [ ] deploy + verify bot joins channels

## Bootstrap (after deploy)
/msg WUNDERkind hello  -> first owner (deemah)
/msg WUNDERkind pass <pw>
