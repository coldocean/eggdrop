...
#        /msg WUNDERkind .status
#        /msg WUNDERkind .adduser someone
#        /msg WUNDERkind .chattr someone +o
#        /msg WUNDERkind .die
...
proc console::run {nick text} {
    ...
    switch -- $cmd {
        help - "" {
            foreach l {
                "\0030,4 \002 CONSOLE \002 \017 /msg WUNDERkind .<cmd>:"
        ...
        status {
            console::reply $nick "\0033WUNDERkind\017 uptime [console::uptime] — channels: [channels] — server: $::server"
        }
