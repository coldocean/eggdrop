# WUNDERkind — Eggdrop IRC bot for the Wunderbar network.
# Compiles Eggdrop 1.9.5 from source (latest stable) with TLS support.
#
# Build:  docker build -t wunderkind .
# Run:    docker run -d --name wunderkind wunderkind
#
FROM debian:trixie-slim AS build

LABEL org.opencontainers.image.title="WUNDERkind Eggdrop Bot" \
      org.opencontainers.image.description="Eggdrop 1.9.5 IRC bot for the Wunderbar network" \
      org.opencontainers.image.source="https://github.com/coldocean/eggdrop"
